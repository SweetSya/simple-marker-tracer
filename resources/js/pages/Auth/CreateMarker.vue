    ...
    <AppLayout>
        <div class="min-h-screen bg-gray-50 p-4">
            ...
            >
                ...
                <div class="p-6">
                    <div v-if="polygons.length === 0" class="py-12 text-center">
                        <svg
                    ...
                    <div v-else class="max-h-80 space-y-4 overflow-y-auto">
                        <div
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ... and {{ polygon.points.length - 4 }} more
                                    points
                                </div>
                            </div>
                        </div>
            ...
            <div class="mt-6 text-center">
                <button
                    ...
                    :class="[
                        'transform rounded-xl px-8 py-4 text-lg font-semibold transition-all duration-200',
...
const savePolygons = async () => {
    ...
    try {
        ...
        alert(`Successfully saved ${polygons.value.length} polygon(s)!`);
